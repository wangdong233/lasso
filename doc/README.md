...
> Lasso（npm `lasso-mcp`）doc/ 目录索引。更新：2026-09-17（v1.28.0 预写态 · BUG-10 **doc 收卷终态**——实机报告处置后记 + bugs/10 状态转「已实施收口」+ ARCHITECTURE §16.8 回执体系/计数 3186/196/103 + 排期表 v1.27.0/v1.27.1 转已发布 + v1.28.0 行 + testing/01 ④″ 触发登记 + README v1.28.0 前缀统一〔中英双语〕；上轮 doc 收卷见 git `d635576`/`9b7ee97`，删除类处置见 [整理决议-2026-09-16.md](整理决议-2026-09-16.md) 先报后删）。
