...
- README.md / README.en.md / doc/KEY-GUIDE.md 用户向同步（freshness / 桌面 act / LASSO_PROXY / 版本头）。
...
- 真机手测清单（doc/19-最优性审查轮次/round1-manual-test-checklist.md）：sannysoft（T1/T2）、桌面 ax_act（T3）、CGEvent 鼠标（T7）、Event Synthesizing 15+（T11 N/A 本机 12）——全部 ⏳ 待真机回填，不伪造已验证。
