...
>
> 设计原则见 [08 §3.8 F3.8.1-8](../architecture/01-功能架构.md)；实施排期见 [09 §2.7 v0.7 SerpHealthMonitor](../architecture/02-实施排期.md)。
...
- [TROUBLESHOOTING.md](02-TROUBLESHOOTING.md) — error_kind 释义（含 `recording_replay_miss`）
- [ARCHITECTURE.md](../../ARCHITECTURE.md) — 架构概览（含 fallback 链）
- [doc/architecture/01 功能架构 §3.8](../architecture/01-功能架构.md) — SERP 抽取设计（F3.8.1-8）
- [doc/architecture/02 实施排期 §2.7](../architecture/02-实施排期.md) — v0.7 SerpHealthMonitor 设计决策
