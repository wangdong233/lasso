...
> **维护规则（时效标注制度，v1.14 起）**
>
> **轻核对（2026-08-27，v1.18.4）**：v1.17.2→v1.18.4 六版均为静默性/看门狗/rust-helper/错配守卫面，**未新增任何 key/供应商/env 面**——本手册供应商口径无需变更。90 天时效标注（2026-08-17/18）仍在期内，**下次重核 ≈ 2026-11**，首查项不变：Brave 免费计划超额是否扣卡（控制台亲历）。
>
