...
> 2026-08-18 · doc/governance/05 颠覆性调研 verdict 产物。裁决官已抽验四份 scan + zero-base + red-team 的关键声称（源码行号亲验 / Brave 官方博客亲读 / 本机 key 状态亲查），本文只写站得住的部分。
...
| F3 | Brave 免费档 2026-02 取消，$5/1k + $5/月赠送额度（需站点 attribution） | doc/governance/02 verdict（官方页亲取）+ 本轮 Brave 博客亲读复核 |
...
| F9 | worked 无质量轴：brave SERP 刮出 font-face CSS「20/20 全垃圾」、百度「worked+17 条 hao123」两起事故机器闸门全绿、人工才抓到（v1.15 verify 记录） | red-team R4（doc/governance/04+05 档案） |
