...
> 2026-08-17。调研员：agent-api scan。方法论纪律（doc/governance/04 首次执行）：零基视角出发 / 每条声称附成本与延迟（L-COST）/ 禁止「开源项目都这样做」当最优证据。
