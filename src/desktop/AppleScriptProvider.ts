 ...
 *
 *   Rust 端错误（透传）：
 *     - error_kind=tcc_denied     → outcome=unknown（v1.18.2 doc/governance/10 Y4：Automation TCC 被拒是本档权限缺失，链继续试下一档；不再短路）
 ...
 *
 * v1.18.2（doc/governance/10 Y4）：tcc_denied 移出本集 → unknown。AppleScript 的 Automation
