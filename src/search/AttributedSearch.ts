 ...
 * 「这条来自 search.machine_mcp / search.brave / browse_headless」。
 *
 * 设计：
 ...
 * "search.machine_mcp,search.brave"（不区分单条出自哪家）；v0.3 升级 per-item attribution
 ...
 * @param servedBy 聚合 served_by 字符串（fanout 是 "src1,src2"，单源是 "search.machine_mcp"）
 *
