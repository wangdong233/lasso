...
export const SEARCH_DESCRIPTION = [
  ...
  "                     search_recency_filter / Brave freshness / Bing freshness;",
  "                     Bing has no year granularity and silently skips the filter",
  "                     for 'year'). Omitted = no time filter = byte-identical",
  "                     baseline. Use for news / release-tracking / 'latest' queries.",
  "",
  "ENGINE CHOICE (v0.9):",
