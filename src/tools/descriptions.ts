...
export const BROWSE_HEADLESS_DESCRIPTION = [
  ...
  "               url ≠ current page → lasso navigates FIRST, then runs the JS there",
  "               (did_navigate:true); url equal to the current page runs in place with",
  "               zero overhead (did_navigate:false); omit url to run on the current",
  "               page (same-session contract as current-page screenshot/wait).",
...
export const DESKTOP_DESCRIPTION = [
  ...
  "               ok:false + cgevent_no_landing = the event did NOT land — visible",
  "               failure, not silent). Dispatch-level physical_input.attribution",
  ...
  "               holds the path (browse-channel parity). options.inline_base64:",
  "               true returns screenshot_base64 inline (token-heavy — full-screen",
