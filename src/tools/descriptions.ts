...
export const BROWSE_HEADLESS_DESCRIPTION = [
  ...
  "  wait       — wait_for text (opts.expect.text); url omitted = current-page wait",
  "               (BUG-08 D-3: waits on the page this channel already manages —",
  "               requires an active session, same contract as current-page",
  "               screenshot; no session → didnt + no_active_session:",
  "               current_page_wait, never silently waits on a blank page)",
  ...
  "               URL SEMANTICS (BUG-08 D-2): passing url = ensure-navigation — if it",
  "               differs from the current page (or no page yet), lasso navigates",
  "               FIRST, then runs the JS there; url equal to the current page runs",
  "               in place with zero overhead; omit url to run on the current page.",
  ...
  "",
  "Args:  url (str, optional for action=screenshot / wait = current-page mode;",
  ...
  "                               Omit ONLY with action=screenshot (shoot) or",
  "                               action=wait (await text) to act on the page",
  "                               this channel already manages (zero navigation); any",
  "                               other action without url → didnt +",
...
export const BROWSE_LOGGED_IN_DESCRIPTION = [
  ...
  "  evaluate ensure-navigation (D-2: url ≠ current page navigates first), and",
  "  automatic port discovery when default 9222 has no CDP (E-1 — result",
  "  retrieval_method carries +auto_discovered_port:<port>). freshProfile is",
  ...
  "",
  "Args:  url (str, optional for action=screenshot = current-page mode; required",
  "                               otherwise) — http(s) URL (file:// only via",
  "                               LASSO_ALLOW_FILE_FROM)",
  "       action (str, default 'snapshot')",
