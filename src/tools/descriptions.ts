...
export const BROWSE_HEADED_DESCRIPTION = [
  ...
  "",
  "Eviction companion: when a site evicts headless automation (evaluate dies",
  "  with 'Execution context was destroyed' seconds after a successful load),",
  "  ASK THE USER FIRST, then retry here for JS-resident needs.",
  "",
