...
export const BROWSE_LOGGED_IN_DESCRIPTION = [
  ...
  "refs (v1.17), console_level/console_limit (BUG-05 C), current-page screenshot",
  "(BUG-07) and current-page wait (BUG-08 D-3), hash-navigation reload (BUG-08 D-1)",
  "and evaluate ensure-navigation (BUG-08 D-2; freshProfile is headless-only and",
  "rejected here — your real Chrome identity is never rotated):",
