...
export const BROWSE_HEADLESS_DESCRIPTION = [
  ...
  "",
  "Args:  url (str, required)   — http(s) URL (userinfo @ forbidden); file:// URLs",
  "                               are rejected by default (opt-in per-dir via env",
  "                               LASSO_ALLOW_FILE_FROM, colon-separated)",
...
export const BROWSE_LOGGED_IN_DESCRIPTION = [
  ...
  "refs (v1.17), console_level/console_limit (BUG-05 C). High-risk",
  ...
  "",
  "Args:  url (str, required)   — http(s) URL (file:// only via LASSO_ALLOW_FILE_FROM)",
  "       action (str, default 'snapshot')",
