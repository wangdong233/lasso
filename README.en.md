...
**Current version v1.29.1** (changelog in the collapsed block at the end of this section).
...
<details>
<summary>📋 Changelog (v1.8 → v1.29.1 — click to see what each version changed)</summary>
