...
**Current version v1.30.0** (changelog in the collapsed block at the end of this section).
...
<details>
<summary>📋 Changelog (v1.8 → v1.30.0 — click to see what each version changed)</summary>
